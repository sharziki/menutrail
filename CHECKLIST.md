...
- [x] **15. Mandatory modifier popup** - Can't add to cart without required modifier selections ✅
- [x] **16. Checkout upcharge popups** - Modifiers with prices shown in popup (via item popup) ✅
- [x] **17. Pickup order sound** - 6 second sound for pickup orders ✅
- [x] **18. Drag orders backwards** - Admin can move orders to previous status ✅
- [x] **19. Auto-print tickets** - Tickets print automatically on new order ✅
...
| 15 | Mandatory modifier popup | ✅ Done | 2026-02-08 | Required modifiers block add to cart |
| 16 | Checkout upcharge popups | ✅ Done | 2026-02-08 | Prices shown in modifier popup |
| 17 | Pickup order sound | ✅ Done | 2026-02-08 | 6 second sound for pickups |
| 18 | Drag orders backwards | ✅ Done | 2026-02-08 | Back button on each order card |
| 19 | Auto-print tickets | ✅ Done | 2026-02-08 | Toggle in header, prints on new order |
